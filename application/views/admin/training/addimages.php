...
<style>
    ...
    <div class="content">
		...
		<ul class="breadcrumb">
            ...
            <li class="active"> <span class="divider">/</span> Add Images</li>
        </ul>
...
echo validation_errors(); 
 echo form_open_multipart("admin/training/addimages/$trainingid");?>
    <input id="images" value="" name="images[]" size="50" type="file" class="medium" multiple />
    <input id="add_images" name="add_images" type="submit" class="btn" value="Add"/>
<?php form_close(); ?>
</div>