    <div class="content">
		...
		<ul class="breadcrumb">
			<li><a href="<?php echo base_url(); ?>admin/clientdashboard">Home</a> <span class="divider">/</span></li>
			<li class="active">Account Setting</li>
		</ul>

<div class="container-fluid">
<form method="post" action="<?php echo base_url()?>admin/setting/updatesetting">
<div class="row-fluid">
	<div class="dialog">
        <div class="block">
            <p class="block-heading">Admin Account Setting</p>
            <div class="block-body">
					...
					To change password <a href="<?php echo base_url();?>admin/setting/changepassword">Click here </a>
